...
HitMap Collision::initializeCollisionMap()
{
	...
	phm[typesPair(typeid(Snake),         typeid(Ladder))] = &monsterItem;
	phm[typesPair(typeid(Ant),           typeid(Ladder))] = &monsterItem;
	phm[typesPair(typeid(Alligator),     typeid(Ladder))] = &monsterItem;
	phm[typesPair(typeid(Bee),           typeid(Ladder))] = &monsterItem;
	phm[typesPair(typeid(Bird),          typeid(Ladder))] = &monsterItem;
	phm[typesPair(typeid(Frog),          typeid(Ladder))] = &monsterItem;
	...
	phm[typesPair(typeid(Player),         typeid(Ladder))] = &playerVine;
