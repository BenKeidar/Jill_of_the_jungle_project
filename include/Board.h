...
enum types {
	floor_object = '#', apple_object = 'A', wall_object = 'W', key_gate_object = 'G', key_object = 'K', spikes_object = 'S',
	ladder_object = 'V', diamond_object = 'D', gem_gate_object = 'J', special_wall_object = '@', alligator_object = '!', ant_object = 'T',
	bee_object = 'Y', bird_object = 'B', snake_object = 'U', frog_object = 'F', player_object = 'P'
};
