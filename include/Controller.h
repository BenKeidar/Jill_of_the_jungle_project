...
enum presents {Life = '1', Score = '2', Time = '3', Shield = '4' };
...
public:
	...
	void move(float distance_x, float distance_y, Board& level, bool move, float dirc, float clock_sample) ;// movement function
